        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-md">
              Занятия для учеников 1–4 класса, подготовка к ВПР. Офлайн.
            </p>
      ...
      <section id="summer" className="py-20 relative overflow-hidden bg-gradient-to-br from-teal-500 via-teal-600 to-green-600">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-white">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { emoji: "🎲", title: "История денег", desc: "Настольные игры о том, как появились деньги и как ими управлять. Интересно и познавательно!", price: "", tag: "Июнь–Август" },
              { emoji: "🌍", title: "Путешествия, не выходя из комнаты", desc: "Изучаем страны, культуры и людей через игры, карты и истории. Весело и без скуки!", price: "", tag: "Июнь–Август" },
              { emoji: "🎁", title: "Подарки своими руками", desc: "Весёлые игры на логику, внимание и ассоциации — и мастерим подарки для близких!", price: "", tag: "Июнь–Август" },
            ].map(card => (
